...
macro_rules! meature_elapsed_time {
    ($t:tt,$s:block) => {{
...
pub fn generate_mandelbrot_set(
    ...
    meature_elapsed_time!("generate:wasm\telapsed:", {
...
pub fn draw_mandelbrot_set() {
    ...
    let mut result = meature_elapsed_time!("generate:wasm\telepsed:", {
        logic::generate_mandelbrot_set(canvas_w, canvas_h, X_MIN, X_MAX, Y_MIN, Y_MAX, MAX_ITER)
    });
    meature_elapsed_time!("draw:wasm\telepsed:", {
